...
class ObserveRouteWiringTests(unittest.TestCase):
    ...
    def test_observe_escalates_and_audits(self):
        ...
        self.assertEqual(out["escalation"]["channels"], ["ios_emergency_sos"])

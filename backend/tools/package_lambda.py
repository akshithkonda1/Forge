#!/usr/bin/env python3
"""Package backend/app into a Lambda zip (same layout Terraform uses)."""
...
DEFAULT_OUTPUT = REPO_ROOT / "terraform" / "build" / "forge-backend.zip"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=APP_DIR,
        help="Lambda source directory (default: backend/app)",
    )
    parser.add_argument(
        "--output",
        type=Path,

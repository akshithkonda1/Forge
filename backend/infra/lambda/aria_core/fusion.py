...
from .biometrics import BodyModel, classify_batch
from .biometrics.body_model import redact_snapshot
from .biometrics.types import MetricType
...
def baselines_from_model(model: BodyModel) -> PersonalBaselines:
    from .biometrics import statistics as st

...
Every existing `from services import context_plan` /
`from services.context_plan import X` caller keeps working unchanged: this
aliases sys.modules so the old path *is* the new module, public and
private names alike."""

import sys

from aria_core import context_plan as _real

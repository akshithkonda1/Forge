...
Every existing `from services import contextual_parsing` /
`from services.contextual_parsing import X` caller keeps working unchanged:
this aliases sys.modules so the old path *is* the new module, public and
private names alike."""

import sys

from aria_core import contextual_parsing as _real

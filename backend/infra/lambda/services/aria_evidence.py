...
Every existing `from services import aria_evidence` /
`from services.aria_evidence import X` caller keeps working unchanged: this
aliases sys.modules so the old path *is* the new module, public and
private names alike."""

import sys

from aria_core import aria_evidence as _real

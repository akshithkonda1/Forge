...
_ALIASES: dict[str, MetricType] = {
    ...
    # aging — every app ships a different name; ingest all of them
    "chronological_age": MetricType.CHRONOLOGICAL_AGE, "chrono_age": MetricType.CHRONOLOGICAL_AGE,
    "calendar_age": MetricType.CHRONOLOGICAL_AGE, "age_years": MetricType.CHRONOLOGICAL_AGE,
    "dateofbirth": MetricType.CHRONOLOGICAL_AGE, "date_of_birth": MetricType.CHRONOLOGICAL_AGE,
    "biological_age": MetricType.BIOLOGICAL_AGE, "biologicalage": MetricType.BIOLOGICAL_AGE,
    "bio_age": MetricType.BIOLOGICAL_AGE, "bioage": MetricType.BIOLOGICAL_AGE,
    "apple_biological_age": MetricType.BIOLOGICAL_AGE,
    "true_age": MetricType.BIOLOGICAL_AGE, "trueage": MetricType.BIOLOGICAL_AGE,
    "real_age": MetricType.BIOLOGICAL_AGE, "realage": MetricType.BIOLOGICAL_AGE,
    "fitness_age": MetricType.FITNESS_AGE, "fitnessage": MetricType.FITNESS_AGE,
    "garmin_fitness_age": MetricType.FITNESS_AGE, "physio_age": MetricType.FITNESS_AGE,
    "physioage": MetricType.FITNESS_AGE, "physiological_age": MetricType.FITNESS_AGE,
    "phenotypic_age": MetricType.PHENOTYPIC_AGE, "phenotypicage": MetricType.PHENOTYPIC_AGE,
    "pheno_age": MetricType.PHENOTYPIC_AGE, "phenoage": MetricType.PHENOTYPIC_AGE,
    "vascular_age": MetricType.VASCULAR_AGE, "vascularage": MetricType.VASCULAR_AGE,
    "arterial_age": MetricType.VASCULAR_AGE, "heart_age": MetricType.VASCULAR_AGE,
    "heartage": MetricType.VASCULAR_AGE, "withings_vascular_age": MetricType.VASCULAR_AGE,
    "metabolic_age": MetricType.METABOLIC_AGE, "metabolicage": MetricType.METABOLIC_AGE,
    "body_age": MetricType.METABOLIC_AGE, "bodyage": MetricType.METABOLIC_AGE,
    "inbody_age": MetricType.METABOLIC_AGE,
    "inner_age": MetricType.INNER_AGE, "innerage": MetricType.INNER_AGE,
    "ultrahuman_inner_age": MetricType.INNER_AGE, "oura_age": MetricType.INNER_AGE,
    "readiness_age": MetricType.INNER_AGE,
    "cardio_age": MetricType.CARDIO_AGE, "cardioage": MetricType.CARDIO_AGE,
    "vo2_age": MetricType.CARDIO_AGE, "vo2age": MetricType.CARDIO_AGE,
    "cardio_fitness_age": MetricType.CARDIO_AGE,
    "hrv_age": MetricType.HRV_AGE, "hrvage": MetricType.HRV_AGE,
    "autonomic_age": MetricType.HRV_AGE, "recovery_age": MetricType.HRV_AGE,
}

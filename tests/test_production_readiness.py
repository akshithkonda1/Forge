...
from auth import extract_user_id  # noqa: E402
from handler import handler  # noqa: E402
from production_health import collect_readiness_checks, health_status  # noqa: E402
from responses import RouteError  # noqa: E402
from runtime import allow_seed_fallback  # noqa: E402
...
class ProductionReadinessTests(unittest.TestCase):
    ...
    def test_health_reports_degraded_until_fully_production_ready(self):
        with mock.patch("production_health.terra_config.is_configured", return_value=True):

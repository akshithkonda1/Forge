...
enum AriaFirstHealthBriefing {
    ...
    static func identityBody() -> String {
        ...
        I read Apple Health, last night, last session, busy windows on your calendar (never the titles — a wedding or a trip is a kind, not a guest list), and what’s on your board. I write notes, remember facts, log water, schedule a nudge, and build a session from the library — calisthenics and sports included. Tell me you played tennis and I’ll put it on the session. I don’t invent fertility charts. I don’t diagnose.
        """
    }

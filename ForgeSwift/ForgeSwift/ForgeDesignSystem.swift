...
enum FDS {
    ...
    enum Spring {
        static let snap     = Animation.spring(Spring(response: 0.25, dampingRatio: 0.75))
        static let standard = Animation.spring(Spring(response: 0.35, dampingRatio: 0.75))
        static let hero     = Animation.spring(Spring(response: 0.45, dampingRatio: 0.70))
        static let floaty   = Animation.spring(Spring(response: 0.55, dampingRatio: 0.65))
        static let page     = Animation.spring(Spring(response: 0.40, dampingRatio: 0.80))
        /// Slow inhale — used for ARIA reveals and orb breath.
        static let fluid    = Animation.spring(Spring(response: 0.82, dampingRatio: 0.78))
    }
